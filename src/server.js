...
const serve = (path, cache) => express.static(resolve(path), {
  maxAge: cache && env.isProd ? 60 * 60 * 24 * 30 : 0
})
...
// headers.
const isCacheable = req => env.useMicroCache

app.get('*', env.isProd ? render : (req, res) => {
  readyPromise.then(() => render(req, res))
})

app.listen(env.serverPort, '0.0.0.0', () => {
  console.log(`Server started at localhost:${env.serverPort}`)
})
